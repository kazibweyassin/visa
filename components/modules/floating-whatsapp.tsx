...
export function FloatingWhatsApp() {
  ...
  return (
    <Link
      ...
      className="group fixed bottom-6 right-6 z-50 flex h-12 items-center gap-2 overflow-hidden rounded-full bg-[var(--green)] px-4 shadow-lg transition-all duration-300 hover:pr-6 hover:bg-[var(--green-dim)]"
    >
      {/* Icon */}
