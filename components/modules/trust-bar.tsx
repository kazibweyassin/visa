...
export function TrustBar() {
  return (
    <section className="bg-[#0B1324] py-6">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-3 rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 text-sm text-slate-200 shadow-2xl shadow-black/20 sm:grid-cols-2 lg:grid-cols-5">
          {signals.map((signal, index) => (
            <motion.div
              ...
              className="rounded-2xl bg-white/[0.04] px-3 py-3"
            >
              <signal.icon className="h-4 w-4 text-[#F4C15D]" />
